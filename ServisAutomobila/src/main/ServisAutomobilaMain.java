...
public class ServisAutomobilaMain {
	...
	public static void main(String[] args) {
		...
		Serviser serviser1 = new Serviser("Petar", "Petrovic", "1705889922234",Pol.M , "Cara Lazara 92", "0645789898", "pera", "123", 10000, SpecijalizacijaServisera.Automehanicar);
		...
		Automobil auto1 = new Automobil(musterija1, Marka.AUDI, Model.R8, 2015, "200ks", "2000ccm", VrstaGoriva.Benzin);
		
		Deo deo = new Deo(Marka.AUDI, Model.R8, "Kocnice", 20000);
		ArrayList<Deo>listaDelovaAudi = new ArrayList<Deo>();
		
		Date datum = new Date(2020, 6, 17);
		
		Servis servis1 = new Servis(auto1, serviser1, datum, "Promena kocnica", listaDelovaAudi);
		
		
		ArrayList<Servis>listaServisa = new ArrayList<Servis>();
		listaServisa.add(servis1);
		
		ServisnaKnjizica sKnjizica1 = new ServisnaKnjizica(auto1, listaServisa);
